        ...
        <div class="DOCMng-right">
            <div class="detailedInfo">
                ...
                <div class="detInfoList" @scroll="handleScroll">
                    <div class="scrollBox">
                        <el-card class="box-card" v-for="(item,ind) in DOCListAry" :key="ind">
                            ...
                            <div class="fileCardSingle__info">
                                ...
                                <div class="checkDetail">
                                    <el-button type="primary" @click="seeDOCInfo(item)">详情</el-button>
                                </div>
                            </div>
                        </el-card>
                    </div>
...
export default {
    ...
    methods: {
        ...
        getProject(){
            var that = this;
            apiClient.post("ssiteapi/project/DOC/treeProject",{}, function(pres){
                if (pres.status == 200) {
        ...
        getFileNum(){
            ...
            apiClient.post('ssiteapi/project/DOC/getFileNum',param,function(pres){
                if(pres.status == 200){
        ...
        seeDOCInfo(item){
            var that = this;
            that.infoType = 'edit';
            apiClient.get('ssiteapi/project/DOC/getDetail/'+item.qId,{},function(pres){
                if(pres.status == 200){
            ...
            that.$refs['addCheckForm'].validate(valid=>{
                if(valid){
                    if(that.infoType == 'add'){
                        apiClient.linkApi('ssiteapi/project/DOC/insertDOC','put',param,function(pres){
                            if(pres.status == 200){
                        ...
                        apiClient.post('ssiteapi/project/DOC/updateDOC',param,function(pres){
        ...
        getDOCList(){
            ...
            if(that.getType == 'add'){
                apiClient.post('ssiteapi/project/DOC/listDOC',param,function(pres){
                    if(pres.status == 200){
                        if(pres.results.list > 0){
                            that.DOCListAry.push(pres.results.list);
                        }else {
                ...
                apiClient.post('ssiteapi/project/DOC/listDOC',param,function(pres){
                    if(pres.status == 200){
                        that.DOCListAry = pres.results.list;
                    }
                })
            }
